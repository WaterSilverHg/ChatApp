...
//            OATPP_LOGE("SQL_ERROR", "%s", userResult->getErrorMessage());
//        }
//        #endif
...
//        #ifdef SQLCHECK
//        if (!result->isSuccess()) {
//            OATPP_LOGE("SQL_ERROR", "%s", result->getErrorMessage());
//        }
//        #endif
...
//        }
//        #endif
//        ASYNC_THROW_IF(result->isSuccess(), "重置密码失败");
//        return true;
//    }
//
...
//    //    auto result = m_appPostgresql->getUserById(id);
//    //    #ifdef SQLCHECK
...
//        auto userIdNum = m_idCache->getUserId(userId);
//        ASYNC_THROW_IF(userIdNum > 0, "用户不存在或已失效");
//
...
//            OATPP_LOGE("SQL_ERROR", "%s", updateResult->getErrorMessage());
//        }
//        #endif
//        ASYNC_THROW_IF(updateResult->isSuccess() && updateResult->hasMoreToFetch(), "修改密码失败");
//
//        return true;
//    }
//
